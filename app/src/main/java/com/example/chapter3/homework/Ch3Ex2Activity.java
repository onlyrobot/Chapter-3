...
public class Ch3Ex2Activity extends AppCompatActivity {
    ...
    private void resetTargetAnimation() {
        ...
        scaleXAnimator.setDuration(Integer.parseInt(durationSelector.getText().toString())); scaleXAnimator.setRepeatMode(ObjectAnimator.REVERSE);
        ObjectAnimator scaleYAnimator = ObjectAnimator.ofFloat(target,"scaleY", 1.0f, 2.0f);
        scaleYAnimator.setRepeatCount(ObjectAnimator.INFINITE); scaleYAnimator.setInterpolator(new LinearInterpolator());
        scaleYAnimator.setDuration(Integer.parseInt(durationSelector.getText().toString())); scaleYAnimator.setRepeatMode(ObjectAnimator.REVERSE);
